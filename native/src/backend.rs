...
const BACKEND_NAME: &str = "copy-fail-mcp-backend.exe";
const BACKEND_PORT: u16 = 10955;
const BACKEND_TAG: &str = "copy-fail-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "COPY_FAIL_MCP_PORT";
const ENV_HOST: &str = "COPY_FAIL_MCP_HOST";
const ENV_TAURI: &str = "COPY_FAIL_MCP_TAURI";
