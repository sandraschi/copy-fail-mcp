...
Write-Host "Starting Copy Fail MCP backend on port $BackendPort ..." -ForegroundColor Cyan
$backendCmd = "Set-Location '$ProjectRoot'; uv run copy-fail serve --http --port $BackendPort"
