...
4. Start the server:
   ...
   uv run python -m copy_fail_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn copy_fail_mcp.server:app --port 10955
   ```
...
5. Open `http://localhost:10955` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/copy-fail-mcp/issues) |
